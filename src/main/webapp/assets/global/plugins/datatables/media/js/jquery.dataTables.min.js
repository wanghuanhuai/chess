...
sEmptyTable:"No data available in table",sInfo:"显示第 _START_ 条到 _END_ 条记录,一共 _TOTAL_ 条  ",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(过滤来自 _MAX_ 条总记录)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"搜索:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有对应的记录"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
