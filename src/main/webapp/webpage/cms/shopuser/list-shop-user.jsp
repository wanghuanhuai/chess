              ...
              <div class="portlet box blue">
                ...
                <div class="portlet-body">
                  ...
                  <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                    ...
                    <c:forEach items="${shopUsers}" var="item">
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="edit" href="/admin/cms/shopUser/editPage.do?id= ${item.id}">
                            编辑 </a>
                        </td>
                      </tr>
                    </c:forEach>
...
<script src="<%=basePath%>/assets/admin/pages/scripts/shop-user-editable.js"></script>
